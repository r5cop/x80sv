...
move_base_msgs::MoveBaseGoal mb_goal;
 ...
 mb_goal.target_pose.pose.position.y=check.position.y;
...
//{
 ...
 ros::Subscriber pose_sub = nh.subscribe<geometry_msgs::Pose>("vision_coordinates/x80sv", 1, boost::bind(PoseCallback, _1, &ac));
